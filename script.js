...
$.ajax ({
	...
	let forecasteIcon1 = data.list[0].weather[0].description;
	if (forecasteIcon1 == "broken clouds") {
       ...
       let forecasteIcon2 = data.list[8].weather[0].description;
      ...
      if (forecasteIcon2 == "Clear") {
       ...
       let forecasteIcon3 = data.list[16].weather[0].description;
      ...
      if (forecasteIcon3 == "Clear") {
       ...
       let forecasteIcon4 = data.list[24].weather[0].description;
      ...
      if (forecasteIcon4 == "Clear") {
       ...
       let forecasteIcon5 = data.list[32].weather[0].description;
...
// 	let day1 = new Date(data.list[0]).dt*1000;
// 	let day2 = new Date(data.list[0]).dt*1000;
// 	let day3 = new Date(data.list[0]).dt*1000;
// 	let day4 = new Date(data.list[0]).dt*1000;
// 	let day5 = new Date(data.list[0]).dt*1000;

// 	document.querySelector(".days-name1").innerHTML=days[day1.getDay()];
// 	document.querySelector(".days-name2").innerHTML=days[day2.getDay()];
// 	document.querySelector(".days-name3").innerHTML=days[day3.getDay()];
// 	document.querySelector(".days-name4").innerHTML=days[day4.getDay()];
// 	document.querySelector(".days-name5").innerHTML=days[day5.getDay()];
// 	}
...
// 		let weatherDescrip = data.list[0].weather[0].main;

	// 		if (weatherDescrip === `Clouds`){
	// 			document.querySelector(".icons").innerHTML = `<i class="wi wi-day-cloudy"></i>`;
	// 		} else if (weatherDescrip === "clear") {
	// 			document.querySelector(".icons").innerHTML = `<i class="wi wi-night-clear"></i>`;

	// 		} else if(weatherDescrip === "smoke"){
	// 			document.querySelector(".icons").innerHTML = `<i class="wi "></i>`;

	// 		} else if(weatherDescrip === "few clouds"){
	// 			document.querySelector(".icons").innerHTML = `<i class="wi "></i>`;

	// 		} else if(weatherDescrip === "broken clouds"){
	// 			document.querySelector(".icons").innerHTML = `<i class="wi "></i>`;

	// 		} else if(weatherDescrip === "clear sky"){
	// 			document.querySelector(".icons").innerHTML = `<i class="wi "></i>`;
	...
	// document.querySelector(".temp > span").innerHTML = data.list[0].main.temp;
	// document.querySelector(".min").innerHTML = data.main.temp;
	// document.querySelector(".max").innerHTML = data.main.temp;
	...
	// url:63617831300026c7597da58cd6bf64e1
	//api.openweathermap.org/data/2.5/forecast?q=London,us&appid=63617831300026c7597da58cd6bf64e1